        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreditCarCompany = table.Column<string>(nullable: false),
                    CreditCarNumber = table.Column<string>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseOrders_OrderStatus_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PurchaseOrderItems_OrderItemStatus_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrderItems_StatusId",
                table: "PurchaseOrderItems",
                column: "StatusId");
